...
{
    public class FarseerTest : GameWindow
    {
        ...
        public FarseerTest()
            : base(800, 450, GraphicsMode.Default, "Farseer Physics - Test")
        {
            ...
            world = new World(new XNA.Vector2(0f, 9.8f));
            boxes = new List<Body>();
            ...
            rocket.Position = new XNA.Vector2(400f, 225f) * pixelToUnit;
            ...
            platform.Position = new XNA.Vector2(400f, 825f) * pixelToUnit;
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            Vector2 rocketPosition = new Vector2(rocket.Position.X, rocket.Position.Y) * unitToPixel;
            ...
            {
                XNA.Vector2 boxPos = (box.Position * unitToPixel) - new XNA.Vector2(25f);
                shapeRenderer.SetTransform(
                    Matrix4.CreateTranslation(-boxPos.X - 25f, -boxPos.Y - 25f, 0f) * 
                    Matrix4.CreateRotationZ(box.Rotation) * 
                    Matrix4.CreateTranslation(boxPos.X + 25f, boxPos.Y + 25f, 0f));
                shapeRenderer.DrawRect(new Vector2(boxPos.X, boxPos.Y), new Vector2(50f), Color4.Brown);
            }
        ...
        protected override void OnUpdateFrame(FrameEventArgs e)
        {
            ...
            if (gpadState.Buttons.B == ButtonState.Pressed)
                rocket.ApplyForce(new XNA.Vector2(0f, -2.5f));
            if (gpadState.ThumbSticks.Left.LengthSquared > 0.01f)
                rocket.ApplyForce(new XNA.Vector2(gpadState.ThumbSticks.Left.X, gpadState.ThumbSticks.Left.Y) * 1.5f);
        ...
        private void spawnBox()
        {
            ...
            box.Position = new XNA.Vector2(position.X, position.Y);
